...
public class Main {
	...
	private static String generateFileName(AbstractSortingAlgorithm<MarkedValue<Integer>> algorithm, Generator<Integer> generator) {
    ...
    private static void writeResult(Result result, int testSize, AbstractSortingAlgorithm<MarkedValue<Integer>> algorithm, Generator<Integer> generator) throws IOException {
	...
	private static void printLabel(AbstractSortingAlgorithm<MarkedValue<Integer>> algorithm, int testSize) {
		...
		} else if (algorithm instanceof QuickSortLinkedListOptimised<?>) {
			System.out.println("Test QuickSort optimised for linked lists" + sizeInfo);
		}
	...
	private static void setup() {
		...
		ALGORITHMS.add(new QuickSortLinkedListOptimised<>(markedComparator));
	}
			...
			for (Generator<Integer> generator : GENERATORS) {
				for (Integer testSize : TEST_SIZES) {
                    if (algorithm instanceof QuickSortLinkedListOptimised<MarkedValue<Integer>>) {
                        runTest(algorithm, new LinkedListGenerator<>(generator), testSize);
                    } else {
